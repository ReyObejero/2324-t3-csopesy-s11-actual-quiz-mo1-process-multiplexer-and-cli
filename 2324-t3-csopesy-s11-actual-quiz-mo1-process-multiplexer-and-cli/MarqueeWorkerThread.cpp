...
MarqueeWorkerThread::MarqueeWorkerThread(int refresh_rate, std::string marquee_text) : bounds_bottom_pad_(2), min_marquee_pos_x_(0), min_marquee_pos_y_(4), dx_(3), dy_(1) {
